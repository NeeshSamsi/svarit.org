 ...
 * (`gsap.timeline({ delay: 0.4 })`, `power2.out`) and staggers the four text
 * elements in reading order so they arrive in sequence.
 */
  ...
  return (
    ...
    >
      <ArtistPhoto
        ...
        className="col-span-full aspect-4/3 rounded-[32px] sm:col-span-5 lg:col-span-4"
      />
