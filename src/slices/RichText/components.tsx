...
// The serializer for the RichText default slice, kept here so the Quote slice's
// supporting paragraph can render through the exact same map and stay visually
// identical to a standalone RichText slice.
export const richTextComponents: JSXMapSerializer = {
  ...
  hyperlink: ({ children, node }) => (
    <PrismicNextLink field={node.data} className="underline hover:font-normal">
      {children}
    </PrismicNextLink>
  ),
  image: ({ node }) => (
